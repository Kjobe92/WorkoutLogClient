...
import { Button, Form, Label, Input, Modal, ModalHeader, ModalBody, FormGroup } from 'reactstrap';
...
const WorkoutEdit = (props) => {
    ...
    const workoutUpdate = (event) => {
        ...
        fetch(`http://localhost:4000/api/log/${props.workoutToUpdate.id}`, {
            method: 'PUT',
            body: JSON.stringify({log: {description: editDesc, defintion: editDef, result: editRes}}),
            headers: new Headers({
